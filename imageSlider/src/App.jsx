...
function App() {
  const images = [
    ...
    "https://images.pexels.com/photos/1443867/pexels-photo-1443867.jpeg?auto=compress&cs=tinysrgb&w=1200",
  ];
  const [curImg, setCurImg] = useState(0);
  const nextImage = useCallback(() => {
    setCurImg((prev) => (curImg === images.length - 1 ? 0 : prev + 1));
  }, [curImg, setCurImg, images]);
  const prevImg = useCallback(() => {
    setCurImg((prev) => (curImg === 0 ? images.length - 1 : prev - 1));
  }, [curImg, setCurImg, images]);
